...
declare class MP4BoxStream {
  ...
  readInt16Array(length: number): Int16Array<ArrayBuffer>;
  readUint16Array(length: number): Int16Array<ArrayBuffer>;
  readUint32Array(length: number): Uint32Array<ArrayBuffer>;
  readInt32Array(length: number): Int32Array<ArrayBuffer>;
}
...
declare class irefBox extends FullBox {
  ...
  references: Array<
    SingleItemTypeReferenceBox | SingleItemTypeReferenceBoxLarge
  >;
  version: number;
  parse(stream: MultiBufferStream): void;
}
...
declare class ISOFile<TSegmentUser = unknown, TSampleUser = unknown> {
  ...
  onSamples:
    | ((id: number, user: TSampleUser, samples: Array<Sample>) => void)
    | null;
  ...
  getBox(type: AllIdentifiers): Box;
  getBoxes(type: AllIdentifiers, returnEarly: boolean): Box[];
  ...
  equal(b: { boxes: Array<Box> }): boolean;
  /**
...
declare class DataStream {
   ...
   */
  readInt8Array(length: number | null): Int8Array<ArrayBuffer>;
  /**
   ...
   * @bundle DataStream-write.js
   */
  writeType<const T extends Type>(
    type: T,
    value: ValueFromType<T>,
    struct?: Record<string, Type>,
  ): number | void;
  /** @bundle DataStream-write.js */
   ...
   */
  readStruct<T extends StructDefinition>(
    structDefinition: T,
  ): StructDataFromStructDefinition<T>;
  /**
...
declare class TrackReferenceTypeBox extends Box {
  ...
  parse(stream: MultiBufferStream | MP4BoxStream | DataStream): void;
  /** @bundle box-write.js */
  write(stream: DataStream): void;
}
...
declare namespace DESCRIPTORS {
  export {
    DESCRIPTORS_Descriptor as Descriptor,
    DESCRIPTORS_ES_Descriptor as ES_Descriptor,
    DESCRIPTORS_MPEG4DescriptorParser as MPEG4DescriptorParser,
  };
}
...
declare namespace BOXES {
  export {
    type BOXES_Assocation as Assocation,
    BOXES_CoLLBox as CoLLBox,
    type BOXES_Extent as Extent,
    BOXES_ItemContentIDPropertyBox as ItemContentIDPropertyBox,
    BOXES_OpusSampleEntry as OpusSampleEntry,
    BOXES_SmDmBox as SmDmBox,
    BOXES_a1lxBox as a1lxBox,
    BOXES_a1opBox as a1opBox,
    BOXES_ac_3SampleEntry as ac_3SampleEntry,
    BOXES_ac_4SampleEntry as ac_4SampleEntry,
    BOXES_aebrBox as aebrBox,
    BOXES_afbrBox as afbrBox,
    BOXES_albcBox as albcBox,
    BOXES_alstSampleGroupEntry as alstSampleGroupEntry,
    BOXES_altrBox as altrBox,
    BOXES_auxCBox as auxCBox,
    BOXES_av01SampleEntry as av01SampleEntry,
    BOXES_av1CBox as av1CBox,
    BOXES_avc1SampleEntry as avc1SampleEntry,
    BOXES_avc2SampleEntry as avc2SampleEntry,
    BOXES_avc3SampleEntry as avc3SampleEntry,
    BOXES_avc4SampleEntry as avc4SampleEntry,
    BOXES_avcCBox as avcCBox,
    BOXES_avllSampleGroupEntry as avllSampleGroupEntry,
    BOXES_avs3SampleEntry as avs3SampleEntry,
    BOXES_avssSampleGroupEntry as avssSampleGroupEntry,
    BOXES_brstBox as brstBox,
    BOXES_btrtBox as btrtBox,
    BOXES_bxmlBox as bxmlBox,
    BOXES_ccstBox as ccstBox,
    BOXES_cdefBox as cdefBox,
    BOXES_clapBox as clapBox,
    BOXES_clefBox as clefBox,
    BOXES_clliBox as clliBox,
    BOXES_cmexBox as cmexBox,
    BOXES_cminBox as cminBox,
    BOXES_cmpdBox as cmpdBox,
    BOXES_co64Box as co64Box,
    BOXES_colrBox as colrBox,
    BOXES_coviBox as coviBox,
    BOXES_cprtBox as cprtBox,
    BOXES_cschBox as cschBox,
    BOXES_cslgBox as cslgBox,
    BOXES_cttsBox as cttsBox,
    BOXES_dOpsBox as dOpsBox,
    BOXES_dac3Box as dac3Box,
    BOXES_dataBox as dataBox,
    BOXES_dav1SampleEntry as dav1SampleEntry,
    BOXES_dec3Box as dec3Box,
    BOXES_dfLaBox as dfLaBox,
    BOXES_dimmBox as dimmBox,
    BOXES_dinfBox as dinfBox,
    BOXES_dmax as dmax,
    BOXES_dmedBox as dmedBox,
    BOXES_dobrBox as dobrBox,
    BOXES_drefBox as drefBox,
    BOXES_drepBox as drepBox,
    BOXES_dtrtSampleGroupEntry as dtrtSampleGroupEntry,
    BOXES_dvh1SampleEntry as dvh1SampleEntry,
    BOXES_dvheSampleEntry as dvheSampleEntry,
    BOXES_ec_3SampleEntry as ec_3SampleEntry,
    BOXES_edtsBox as edtsBox,
    BOXES_elngBox as elngBox,
    BOXES_elstBox as elstBox,
    BOXES_emsgBox as emsgBox,
    BOXES_encaSampleEntry as encaSampleEntry,
    BOXES_encmSampleEntry as encmSampleEntry,
    BOXES_encsSampleEntry as encsSampleEntry,
    BOXES_enctSampleEntry as enctSampleEntry,
    BOXES_encuSampleEntry as encuSampleEntry,
    BOXES_encvSampleEntry as encvSampleEntry,
    BOXES_enofBox as enofBox,
    BOXES_eqivBox as eqivBox,
    BOXES_esdsBox as esdsBox,
    BOXES_etypBox as etypBox,
    BOXES_fLaCSampleEntry as fLaCSampleEntry,
    BOXES_favcBox as favcBox,
    BOXES_fielBox as fielBox,
    BOXES_fobrBox as fobrBox,
    BOXES_freeBox as freeBox,
    BOXES_frmaBox as frmaBox,
    BOXES_ftypBox as ftypBox,
    BOXES_grplBox as grplBox,
    BOXES_hdlrBox as hdlrBox,
    BOXES_hev1SampleEntry as hev1SampleEntry,
    BOXES_hev2SampleEntry as hev2SampleEntry,
    BOXES_hinfBox as hinfBox,
    BOXES_hmhdBox as hmhdBox,
    BOXES_hntiBox as hntiBox,
    BOXES_hvc1SampleEntry as hvc1SampleEntry,
    BOXES_hvc2SampleEntry as hvc2SampleEntry,
    BOXES_hvcCBox as hvcCBox,
    BOXES_hvt1SampleEntry as hvt1SampleEntry,
    BOXES_iaugBox as iaugBox,
    BOXES_idatBox as idatBox,
    BOXES_iinfBox as iinfBox,
    BOXES_ilocBox as ilocBox,
    BOXES_ilstBox as ilstBox,
    BOXES_imirBox as imirBox,
    BOXES_infeBox as infeBox,
    BOXES_iodsBox as iodsBox,
    BOXES_ipcoBox as ipcoBox,
    BOXES_ipmaBox as ipmaBox,
    BOXES_iproBox as iproBox,
    BOXES_iprpBox as iprpBox,
    BOXES_irefBox as irefBox,
    BOXES_irotBox as irotBox,
    BOXES_ispeBox as ispeBox,
    BOXES_itaiBox as itaiBox,
    BOXES_j2kHBox as j2kHBox,
    BOXES_j2kiSampleEntry as j2kiSampleEntry,
    BOXES_keysBox as keysBox,
    BOXES_kindBox as kindBox,
    BOXES_levaBox as levaBox,
    BOXES_lhe1SampleEntry as lhe1SampleEntry,
    BOXES_lhv1SampleEntry as lhv1SampleEntry,
    BOXES_lhvCBox as lhvCBox,
    BOXES_lselBox as lselBox,
    BOXES_m4aeSampleEntry as m4aeSampleEntry,
    BOXES_maxrBox as maxrBox,
    BOXES_mdatBox as mdatBox,
    BOXES_mdcvBox as mdcvBox,
    BOXES_mdhdBox as mdhdBox,
    BOXES_mdiaBox as mdiaBox,
    BOXES_mecoBox as mecoBox,
    BOXES_mehdBox as mehdBox,
    BOXES_metaBox as metaBox,
    BOXES_mettSampleEntry as mettSampleEntry,
    BOXES_metxSampleEntry as metxSampleEntry,
    BOXES_mfhdBox as mfhdBox,
    BOXES_mfraBox as mfraBox,
    BOXES_mfroBox as mfroBox,
    BOXES_mha1SampleEntry as mha1SampleEntry,
    BOXES_mha2SampleEntry as mha2SampleEntry,
    BOXES_mhm1SampleEntry as mhm1SampleEntry,
    BOXES_mhm2SampleEntry as mhm2SampleEntry,
    BOXES_minfBox as minfBox,
    BOXES_mjp2SampleEntry as mjp2SampleEntry,
    BOXES_mjpgSampleEntry as mjpgSampleEntry,
    BOXES_moofBox as moofBox,
    BOXES_moovBox as moovBox,
    BOXES_mp4aSampleEntry as mp4aSampleEntry,
    BOXES_mp4sSampleEntry as mp4sSampleEntry,
    BOXES_mp4vSampleEntry as mp4vSampleEntry,
    BOXES_mskCBox as mskCBox,
    BOXES_msrcTrackGroupTypeBox as msrcTrackGroupTypeBox,
    BOXES_mvexBox as mvexBox,
    BOXES_mvhdBox as mvhdBox,
    BOXES_mvifSampleGroupEntry as mvifSampleGroupEntry,
    BOXES_nmhdBox as nmhdBox,
    BOXES_npckBox as npckBox,
    BOXES_numpBox as numpBox,
    BOXES_padbBox as padbBox,
    BOXES_panoBox as panoBox,
    BOXES_paspBox as paspBox,
    BOXES_paylBox as paylBox,
    BOXES_paytBox as paytBox,
    BOXES_pdinBox as pdinBox,
    BOXES_piffLsmBox as piffLsmBox,
    BOXES_piffPsshBox as piffPsshBox,
    BOXES_piffSencBox as piffSencBox,
    BOXES_piffTencBox as piffTencBox,
    BOXES_piffTfrfBox as piffTfrfBox,
    BOXES_piffTfxdBox as piffTfxdBox,
    BOXES_pitmBox as pitmBox,
    BOXES_pixiBox as pixiBox,
    BOXES_pmaxBox as pmaxBox,
    BOXES_povdBox as povdBox,
    BOXES_prdiBox as prdiBox,
    BOXES_prfrBox as prfrBox,
    BOXES_prftBox as prftBox,
    BOXES_prgrBox as prgrBox,
    BOXES_profBox as profBox,
    BOXES_prolSampleGroupEntry as prolSampleGroupEntry,
    BOXES_psshBox as psshBox,
    BOXES_pymdBox as pymdBox,
    BOXES_rapSampleGroupEntry as rapSampleGroupEntry,
    BOXES_rashSampleGroupEntry as rashSampleGroupEntry,
    BOXES_resvSampleEntry as resvSampleEntry,
    BOXES_rinfBox as rinfBox,
    BOXES_rollSampleGroupEntry as rollSampleGroupEntry,
    BOXES_rtp_Box as rtp_Box,
    BOXES_saioBox as saioBox,
    BOXES_saizBox as saizBox,
    BOXES_sbgpBox as sbgpBox,
    BOXES_sbpmBox as sbpmBox,
    BOXES_sbttSampleEntry as sbttSampleEntry,
    BOXES_schiBox as schiBox,
    BOXES_schmBox as schmBox,
    BOXES_scifSampleGroupEntry as scifSampleGroupEntry,
    BOXES_scnmSampleGroupEntry as scnmSampleGroupEntry,
    BOXES_sdp_Box as sdp_Box,
    BOXES_sdtpBox as sdtpBox,
    BOXES_seigSampleGroupEntry as seigSampleGroupEntry,
    BOXES_sencBox as sencBox,
    BOXES_sgpdBox as sgpdBox,
    BOXES_sidxBox as sidxBox,
    BOXES_sinfBox as sinfBox,
    BOXES_skipBox as skipBox,
    BOXES_slidBox as slidBox,
    BOXES_smhdBox as smhdBox,
    BOXES_ssixBox as ssixBox,
    BOXES_stblBox as stblBox,
    BOXES_stcoBox as stcoBox,
    BOXES_stdpBox as stdpBox,
    BOXES_sterBox as sterBox,
    BOXES_sthdBox as sthdBox,
    BOXES_stppSampleEntry as stppSampleEntry,
    BOXES_strdBox as strdBox,
    BOXES_striBox as striBox,
    BOXES_strkBox as strkBox,
    BOXES_stsaSampleGroupEntry as stsaSampleGroupEntry,
    BOXES_stscBox as stscBox,
    BOXES_stsdBox as stsdBox,
    BOXES_stsgBox as stsgBox,
    BOXES_stshBox as stshBox,
    BOXES_stssBox as stssBox,
    BOXES_stszBox as stszBox,
    BOXES_sttsBox as sttsBox,
    BOXES_stviBox as stviBox,
    BOXES_stxtSampleEntry as stxtSampleEntry,
    BOXES_stypBox as stypBox,
    BOXES_stz2Box as stz2Box,
    BOXES_subsBox as subsBox,
    BOXES_syncSampleGroupEntry as syncSampleGroupEntry,
    BOXES_taicBox as taicBox,
    BOXES_taptBox as taptBox,
    BOXES_teleSampleGroupEntry as teleSampleGroupEntry,
    BOXES_tencBox as tencBox,
    BOXES_tfdtBox as tfdtBox,
    BOXES_tfhdBox as tfhdBox,
    BOXES_tfraBox as tfraBox,
    BOXES_tkhdBox as tkhdBox,
    BOXES_tmaxBox as tmaxBox,
    BOXES_tminBox as tminBox,
    BOXES_totlBox as totlBox,
    BOXES_tpayBox as tpayBox,
    BOXES_tpylBox as tpylBox,
    BOXES_trafBox as trafBox,
    BOXES_trakBox as trakBox,
    BOXES_trefBox as trefBox,
    BOXES_trepBox as trepBox,
    BOXES_trexBox as trexBox,
    BOXES_trgrBox as trgrBox,
    BOXES_trpyBox as trpyBox,
    BOXES_trunBox as trunBox,
    BOXES_tsasSampleGroupEntry as tsasSampleGroupEntry,
    BOXES_tsclSampleGroupEntry as tsclSampleGroupEntry,
    BOXES_tselBox as tselBox,
    BOXES_tsynBox as tsynBox,
    BOXES_tx3gSampleEntry as tx3gSampleEntry,
    BOXES_txtcBox as txtcBox,
    BOXES_tycoBox as tycoBox,
    BOXES_udesBox as udesBox,
    BOXES_udtaBox as udtaBox,
    BOXES_uncCBox as uncCBox,
    BOXES_uncvSampleEntry as uncvSampleEntry,
    BOXES_urlBox as urlBox,
    BOXES_urnBox as urnBox,
    BOXES_viprSampleGroupEntry as viprSampleGroupEntry,
    BOXES_vmhdBox as vmhdBox,
    BOXES_vp08SampleEntry as vp08SampleEntry,
    BOXES_vp09SampleEntry as vp09SampleEntry,
    BOXES_vpcCBox as vpcCBox,
    BOXES_vttCBox as vttCBox,
    BOXES_vttcBox as vttcBox,
    BOXES_vvc1SampleEntry as vvc1SampleEntry,
    BOXES_vvcCBox as vvcCBox,
    BOXES_vvcNSampleEntry as vvcNSampleEntry,
    BOXES_vvi1SampleEntry as vvi1SampleEntry,
    BOXES_vvnCBox as vvnCBox,
    BOXES_vvs1SampleEntry as vvs1SampleEntry,
    BOXES_wbbrBox as wbbrBox,
    BOXES_wvttSampleEntry as wvttSampleEntry,
    BOXES_xmlBox as xmlBox,
  };
}
...
type TypedArray<T extends ArrayBufferLike = ArrayBuffer> =
  | Int8Array<T>
  | Uint8Array<T>
  | Uint8ClampedArray<T>
  | Int16Array<T>
...
type InstanceOf<T> = T extends new (...args: Array<unknown>) => infer R
  ? R
  : never;
type KindOf<T> = InstanceOf<ValueOf<T>>;
type Extends<TObject, TExtends> = {
  [TKey in keyof TObject]: TObject[TKey] extends TExtends
    ? TObject[TKey]
    : undefined;
}[keyof TObject];
type TupleOf<
...
type BoxFourCC = keyof BoxRegistry['box'];
type SampleEntryFourCC = keyof BoxRegistry['sampleEntry'];
type SampleGroupEntryGroupingType = keyof BoxRegistry['sampleGroupEntry'];
type UUIDKeys = keyof BoxRegistry['uuid'];
type AllIdentifiers =
  | BoxFourCC
  | SampleEntryFourCC
  | SampleGroupEntryGroupingType
  | UUIDKeys;
type UUIDKind = InstanceOf<Extends<BoxRegistry['uuid'], typeof Box>>;
type BoxKind = InstanceOf<Extends<BoxRegistry['box'], typeof Box>>;
type SampleEntryKind = InstanceOf<
  Extends<BoxRegistry['sampleEntry'], typeof SampleEntry>
>;
type SampleGroupEntryKind = InstanceOf<
...
type ValueFromType<TValue extends Type> = TValue extends StringType
  ? string
...
type StructDataFromStructDefinition<T extends StructDefinition> = {
  [TKey in T[number][0]]: Extract<
    T[number],
    [TKey, unknown]
  >[1] extends infer TValue
    ? TValue extends Type
...
export {
  AudioSampleEntry as A,
  Box as B,
  DataStream as D,
  Endianness as E,
  FullBox as F,
  HintSampleEntry as H,
  Log as L,
  MetadataSampleEntry as M,
  VisualSampleEntry as V,
  ssixBox as a$,
  hinfBox as aA,
  hmhdBox as aB,
  hntiBox as aC,
  ...
  vttcBox as bc,
  xmlBox as bd,
  SampleGroupEntry as c,
  TrackGroupTypeBox as d,
  SingleItemTypeReferenceBox as e,
  SingleItemTypeReferenceBoxLarge as f,
  TrackReferenceTypeBox as g,
  SampleEntry as h,
  SubtitleSampleEntry as i,
  TextSampleEntry as j,
  SystemSampleEntry as k,
  MultiBufferStream as l,
  createFile as m,
  Descriptor as n,
  ES_Descriptor as o,
  MPEG4DescriptorParser as p,
  SampleGroupInfo as q,
  ISOFile as r,
  MP4BoxBuffer as s,
  MP4BoxStream as t,
  type Description as $,
  type SampleEntryFourCC as C,
  type SampleGroupEntryGroupingType as G,
  type IsoFileOptions as I,
  type AllIdentifiers as J,
  type KindOf as K,
  type NumberTuple as N,
  type UUIDKind as O,
  type BoxKind as P,
  type SampleEntryKind as Q,
  type SampleGroupEntryKind as R,
  type Sample as S,
  type TypedArray as T,
  type UUIDKeys as U,
  type FragmentedTrack as W,
  type ExtractedTrack as X,
  type SampleGroup as Y,
  type Track as Z,
  type Movie as _,
  type BoxRegistry as a,
  type IncompleteBox as a0,
  type Item as a1,
  type EntityGroup as a2,
  type SubSample as a3,
  type Matrix as a4,
  type Nalu as a5,
  type NaluArray as a6,
  type Output as a7,
  type Entry as a8,
  type Reference as a9,
  type Charset as aa,
  type SimpleNumberType as ab,
  type EndianNumberType as ac,
  type NumberType as ad,
  type SimpleStringType as ae,
  type EncodedStringType as af,
  type LengthStringType as ag,
  type EncodedLengthStringType as ah,
  type EndianStringType as ai,
  type StringType as aj,
  type GetterSetterType as ak,
  type TupleType as al,
  type FnType as am,
  type Type as an,
  type ParsedType as ao,
  type StructDefinition as ap,
  type ValueFromType as aq,
  type StructDataFromStructDefinition as ar,
  type DescriptorRegistry as u,
  type ValueOf as v,
  type InstanceOf as w,
  type Extends as x,
  type TupleOf as y,
  type BoxFourCC as z,
};
